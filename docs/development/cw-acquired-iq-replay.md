...
This workflow turns an already retained CW-family CF32LE capture into a portable
...
resolved plan, expected-event timeline, and IQ bytes and must agree with the plan's
