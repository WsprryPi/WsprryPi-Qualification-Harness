...
| 3. Harness capabilities | `application_shims.py`, `carrier.py`, `carrier_plot.py`, `audio.py`, `decoder.py`, `cw_*`, `keyed_*`, `live_keyed.py`, `turnkey_campaign.py`, `complete_test.py` | application-plan, carrier-analysis, audio, decoder, CW, keyed, turnkey, and complete-test configuration/plan/result contracts | application, carrier, decoder, CW, keyed contract/coordinator/live, turnkey, and complete-test routing/failure tests |
